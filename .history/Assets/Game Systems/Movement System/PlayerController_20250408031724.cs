...
namespace UnityTutorial.PlayerControl
{
    public class PlayerController : MonoBehaviour
    {
        ...
        // private void HandleSlid() => _animator.SetBool(_Slid , _inputManager.Slid);
        ...
        private void SampleGround()
        {
            ...
            Debug.DrawRay(_playerRigidbody.worldCenterOfMass, Vector3.down * (Dis2Ground + 0.1f), Color.red);
