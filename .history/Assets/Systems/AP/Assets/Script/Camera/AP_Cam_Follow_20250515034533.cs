...
public class AP_Cam_Follow : MonoBehaviour
{
    ...
    void UpdatePlayerFacing()
    {
        ...
        // Removed direct Rigidbody rotation setting
    ...
    void SyncCameraRotation()
    {
        ...
        float playerYRotation = playerModel.eulerAngles.y;

        transform.rotation = Quaternion.Euler(_xRotation, playerYRotation, 0f);
    }
