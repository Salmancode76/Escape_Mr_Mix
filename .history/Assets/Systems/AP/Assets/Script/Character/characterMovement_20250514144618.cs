...
public class characterMovement : MonoBehaviour
{
    ...
    void bodyMovement()
    {
        ...
        if (_hasAnimator)
        {
            ...
            // Cap the velocity components to the range [-6, 6]
            _currentVelocity.x = Mathf.Clamp(_currentVelocity.x, -6f, 6f);
            _currentVelocity.y = Mathf.Clamp(_currentVelocity.y, -6f, 6f);
