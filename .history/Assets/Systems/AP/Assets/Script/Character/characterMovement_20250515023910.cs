...
public float GetMouseXInput()
{
    if (ingameGlobalManager.instance.b_DesktopInputs)
    {
        ...
        {
            // Return raw mouse input
            return mouseHorizontal;
        }
        else
        {
            // Return raw joystick X input
            return joyHorizontal;
        }
    }
    else
    {
        ...
        {
            return mobileToystickController.inputVector.x;
        }
        else
        {
            return 0f;
...
public float GetMouseYInput()
{
    if (ingameGlobalManager.instance.b_DesktopInputs)
    {
        ...
        {
            // Return raw mouse input
            return mouseVertical * returnInvertMouseAxis();
        }
        else
        {
            // Return raw joystick Y input
            return joyVertical;
        }
    }
    else
    {
        if (b_MobileCamRotation_Stick)
        {
            return mobileToystickController.inputVector.z * returnInvertJoystickAxis();
        }
        else
        {
            return 0f;
