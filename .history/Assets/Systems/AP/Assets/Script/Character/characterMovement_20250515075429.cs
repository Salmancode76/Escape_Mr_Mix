...
public class characterMovement : MonoBehaviour
{
    ...
    [SerializeField] public float targetScaleCrouch = 1f;
...
public float GetMouseYInput()
{
    ...
    private void bodyRotation()
    {
        if (ingameGlobalManager.instance.mouseWaitUnitlFirstMouseMove)
        {
            ...
            objCamera.transform.rotation = _playerRigidbody.rotation * deltaRotation;

            // objCamera.transform.Rotate(0, transform.rotation.eulerAngles.y , 0);
        }
    ...
    {   
        ...
        addForceObj.transform.localEulerAngles = new Vector3(
            ...
            addForceObj.transform.localEulerAngles.y,
