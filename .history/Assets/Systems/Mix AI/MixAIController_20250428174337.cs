    ...
    void HandleFootsteps()
    {
        ...
        if (speed > 0.1f)
        {
            ...
            if (footstepTimer >= interval)
            {
                ...
                {
                    // Always play footsteps even if Mix is not chasing the player
                    SoundFXManager.instance.PlayFootstepsBasedOnDistance(transform, transform, footstepClips, bassClip);
                }
            }
        }
        else
