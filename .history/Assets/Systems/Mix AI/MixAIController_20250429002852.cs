...
private void InstantKillPlayer()
{
    ...
    private void UpdateAnimations()
    {
        ...
        // In OnFollow mode, we're always running toward player
        bool isRunning = (currentState == AIState.Chasing) || (behaviorMode == BehaviorMode.OnFollow && currentState != AIState.Idle);
        ...
        // Debug log to verify animation states
        Debug.Log($"Animator States - Walk: {isMoving && !isRunning}, Run: {isRunning}, Attack: {isAttacking}");
    }
