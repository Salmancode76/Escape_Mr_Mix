...
public class MixAIController : MonoBehaviour
{
    ...
    private void HandleChaseState()
    {
        ...
        {
            // Additional check to ensure we're really close (not separated by obstacles)
        ...
        if (directDistance <= attackRange && hasLineOfSight)
        {
    ...
    private bool CheckDirectLineOfSight()
    {
        ...
        // More permissive raycast (shorter distance, higher origin)
