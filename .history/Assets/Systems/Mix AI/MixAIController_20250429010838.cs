...
public class MixAIController : MonoBehaviour
{
    ...
    private void HandleChaseState()
    {
        ...
        // Calculate direct distance ignoring height difference
        ...
        // Attack normally if within attack range and line of sight
    ...
    private bool CheckDirectLineOfSight()
    {
        ...
        {
            // Check if the ray directly hits the player
            if (hit.transform == playerTransform)
            {
                return true;  // Direct line of sight to player
            }
            else
            {
