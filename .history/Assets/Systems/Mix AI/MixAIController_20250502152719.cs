...
public class MixAIController : MonoBehaviour
{
    ...
    public enum AIState { Idle, Patrolling, Investigating, Chasing, Attacking, CutScene }
    ...
    private void HandleChaseState()
    {
        ...
        // Always use aggressive chasing parameters regardless of mode
        navAgent.SetDestination(playerTransform.position);
        navAgent.acceleration = 20f; // From OnFollow mode
        navAgent.autoBraking = false; // Added for better pursuit
    ...
    private void HandleAttackState()
    {
        ...
        bool inAttackRange = distanceToPlayer <= attackRange * 1.1f;
    ...
    private void OnPlayerDetected()
    {
        if (currentState != AIState.Chasing && currentState != AIState.Attacking)
        {
            ...
            // Force OnFollow-style chasing
            if (behaviorMode == BehaviorMode.OnDetect || behaviorMode == BehaviorMode.OnMahdiLevel)
            {
                // Apply OnFollow parameters
    ...
    private void TransitionToState(AIState newState)
    {
        ...
        switch (currentState)
        {
            case AIState.Attacking: animator.ResetTrigger("Attack"); break;
        ...
        switch (newState)
        {
            ...
            case AIState.Chasing:
                ...
                navAgent.isStopped = false;
                break;
            case AIState.Attacking: navAgent.isStopped = true; break;
            case AIState.CutScene:
                navAgent.isStopped = true;
                cutSceneAudioTimer = 0f;
                isCutScenePlaying = true;
    ...
    private void HandleFootsteps()
    {
        ...
        if (speed > 0.1f)
        {
            ...
            float interval = (currentState == AIState.Chasing || behaviorMode == BehaviorMode.OnFollow) ? 
                            runFootstepRate : walkFootstepRate;
    ...
    private void UpdateAnimations()
    {
        ...
        bool shouldRun = (currentState == AIState.Chasing) || (behaviorMode == BehaviorMode.OnFollow);
