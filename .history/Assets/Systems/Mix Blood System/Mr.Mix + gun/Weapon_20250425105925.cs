    ...
    public class Weapon : MonoBehaviour
    {
        ...
        protected virtual void Shot()
        {
            ...
            if (Physics.Raycast(r, out hitInfo, 1000, ShotMask, QueryTriggerInteraction.Ignore))
            {
                ...
                Renderer targetRenderer = hitInfo.collider.GetComponent<Renderer>();
                ...
                if (targetRenderer != null)
                {
                    ...
                    if (hittable != null)
                    {
                        ...
                        // Project decal if Renderer is valid
                        DecalsProjector.Instance.Project(hitInfo.point, hitInfo.normal, targetRenderer, yourTexture, yourRenderTexture);
                    }
                }
                else
                {
                    Debug.LogError("Renderer is null! Cannot project decal.");
                }
            }
