...
namespace UnityTutorial.PlayerControl
{
    public class PlayerController : MonoBehaviour
    {
        ...
        private void SampleGround()
        {
            ...
            float rayLength = Dis2Ground + 0.2f; // Increased slightly for more tolerance

            Debug.DrawRay(origin, Vector3.down * rayLength, Color.red); // Visualize ray in scene view

            if (Physics.Raycast(origin, Vector3.down, out hitInfo, rayLength, GroundCheck))
            {
                _grounded = true;
