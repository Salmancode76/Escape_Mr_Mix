...
namespace UnityTutorial.PlayerControl
{
    public class PlayerController : MonoBehaviour
    {
        ...
        private void HandleSlide()
        {
            ...
            {
                // Only slide if moving forward with enough speed
        ...
        private void SampleGround()
        {
            ...
            // Calculate origin at bottom of the capsule
            Vector3 capsuleCenter = transform.position + _collider.center;
            float halfHeight    = defaultColliderHeight * 0.5f;
            float rayLength     = halfHeight + 0.1f;  // small buffer

            Debug.DrawRay(capsuleCenter, Vector3.down * rayLength, Color.red);

            if (Physics.Raycast(capsuleCenter, Vector3.down, out RaycastHit hit, rayLength, GroundCheck))
            {
                _grounded = true;
            ...
            else
            {
                ...
                _animator.SetBool(_fallingHash, _playerRigidbody.velocity.y < -0.1f);
            }
        }
