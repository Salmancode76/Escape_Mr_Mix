...
namespace UnityTutorial.PlayerControl
{
    public class PlayerController : MonoBehaviour
    {
        ...
        private float nextFootstepTime = 0f; // Use timestamp instead of float accumulator

        private void HandleFootsteps(bool isMoving)
        {
            if (!isMoving || isSliding || !_grounded)
            {
                nextFootstepTime = 0f;
        ...
        private void HandleJump()
        {
            ...
            hasJumped = true; // prevent re-triggering
        }
        ...
        private void SampleGround()
        {
            ...
            if (!hasPlayedLanding && !isSliding)
            {
                ...
                hasJumped = false; // reset jump flag here
            }
