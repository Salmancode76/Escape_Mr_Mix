...
public class Menu : MonoBehaviour {
	...
	public void OnNewGamePick(int slotIndex) {
		...
		if (PlayerPrefs.GetInt("Saved" + slotIndex) == 0) {
			// Save scene 1 as the starting point, NOT the current scene (main menu = 0)
			...
			// Load the actual game scene (scene 1)
			StartCoroutine(SaveLoadManager.instance.LoadSceneAsync(1));
		} else {
