...
public class PuseMenu : MonoBehaviour {
	...
	public void LoadNextLevel()
	{
		...
		int nextSceneIndex = (currentSceneIndex >= 5) ? 0 : currentSceneIndex + 1;

		// Set the loading text UI
		SaveLoadManager.instance.LoadingText = LoadingText;

		// Use the shared scene loading method from SaveLoadManager
		StartCoroutine(SaveLoadManager.instance.LoadSceneAsync(nextSceneIndex));
	}
