...
namespace AuroraFPSEditor.Attributes
{
    ...
    public class ApexEditor : Editor
    {
        ...
        public void InitializeApexSerializedFields()
        {
            ...
            apexSettings = ApexSettings.ActualSettings;
        ...
        public override Texture2D RenderStaticPreview(string assetPath, Object[] subAssets, int width, int height)
        {
            ...
            if(componentIcon != null)
            {
                ...
                Texture2D icon = AssetDatabase.LoadAssetAtPath<Texture2D>(System.IO.Path.Combine(ApexSettings.RootPath, relativePath,string.Format("{0}.png", componentIcon.name)));
                if(icon != null)
                {
