...
namespace AuroraFPSEditor
{
    internal sealed class AboutWindow : EditorWindow
    {
        ...
        {
            string path = System.IO.Path.Combine(ApexSettings.RootPath, LOGOTYPE_RELATIVE_PATH);
        ...
        private void OnGUI()
        {
            GUILayout.BeginHorizontal();
            {
                ...
                GUILayout.BeginVertical();
                {
                    ...
                    GUILayout.Label("Version: 2.2.0 (Release 2202)", ContentProperties.Version);
                    ...
                    GUILayout.BeginHorizontal();
                    {
                        ...
                        GUILayout.Space(45);
                        GUILayout.Label("Askar Khaibullin\nDinara Gabdullina\nKatya Miroshihina", ContentProperties.Person);
                        GUILayout.FlexibleSpace();
                    }
                    GUILayout.EndHorizontal();
