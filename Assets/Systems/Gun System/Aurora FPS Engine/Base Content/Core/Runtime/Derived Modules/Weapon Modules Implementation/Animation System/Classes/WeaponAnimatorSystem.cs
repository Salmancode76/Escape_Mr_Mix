    ...
    public class WeaponAnimatorSystem : EquippableObjectAnimationSystem
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            if (shootingSystem != null)
            {
                if (playerCamera != null)
                {
                    shootingSystem.OnFireCallback += OnFireWithZoomAction;
                    shootingSystem.OnDryFireCallback += OnDryFireWithZoomAction;
                }
                else
                {
                    shootingSystem.OnFireCallback += OnFireAction;
                    shootingSystem.OnDryFireCallback += OnDryFireAction;
                }
            }
        }
