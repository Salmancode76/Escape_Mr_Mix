...
namespace AuroraFPSRuntime.SystemModules.HealthModules
{
    ...
    public abstract class CharacterHealth : ObjectHealth
    {
        ...
        public GameObject onDeathDisableObject;
        ...
        protected override void OnDead()
        {
            ...
            // Disable reference object if assigned
            if (onDeathDisableObject != null)
            {
                onDeathDisableObject.SetActive(false);
            }
        ...
        public override void TakeDamage(float damage)
        {
            ...
            {
                int index = UnityEngine.Random.Range(0, damageSFX.Length);
                AudioClip clip = damageSFX[index];
        ...
        public void SetHealthEffect(HealthEffect[] value)
        {
            healthEffect = value;
        }
        #endregion
