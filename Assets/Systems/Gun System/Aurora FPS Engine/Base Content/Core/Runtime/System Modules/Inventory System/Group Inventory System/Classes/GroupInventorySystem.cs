...
{
    [HideScriptField]
    [AddComponentMenu("Aurora FPS Engine/System Modules/Inventory/Group Inventory System")]
    ...
    public class GroupInventorySystem : InventorySystem
    {
        ...
        #region [Editor Only Section]
#if UNITY_EDITOR
        private IEnumerable<string> DisplayInputs()
        {
            yield return "None";
